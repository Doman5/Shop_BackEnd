package com.domanski.backend.admin.review.service;

import com.domanski.backend.admin.review.model.AdminReview;
import com.domanski.backend.admin.review.repository.AdminReviewRepository;
...
public class AdminReviewService {
    ...
    public List<AdminReview> getReviews() {
        return adminReviewRepository.findAllByModeratedFalse();
    }
